# install.ps1 — download and install ghscaff on Windows
# Usage: irm https://raw.githubusercontent.com/UniverLab/ghscaff/main/scripts/install.ps1 | iex
#
...
# --- download ---
$Archive = "ghscaff-$Tag-$Target.zip"
$Url     = "https://github.com/$Repo/releases/download/$Tag/$Archive"
$Tmp     = Join-Path $env:TEMP "ghscaff-install"
...
Info "done" $ver
Write-Host ""
Info "ready" "Run 'ghscaff' or 'export GITHUB_TOKEN=<token> && ghscaff' to get started!"
